  ...
  return(
    <HeaderBox>
      <HeaderLeft>
        <Link to="/">
          <div>
            <svg width={constants.layout.width*2} height={constants.layout.height*2} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
            ...
            <img src={Logo} width={constants.layout.width*6} />
          </div>
        </Link>
      </HeaderLeft>
      <HeaderRight>
